...
def train(args):
    ...
    optimizer = torch.optim.AdamW(model.parameters(), lr=0.002, amsgrad=True, weight_decay=0.1)
    ...
    trainer = ImgClassificationTrainer(
        ...
        batch_size=512, val_frequency=5, wab_suffix="_YourCNN"
    )
    trainer.train()


if __name__ == "__main__":
    args = argparse.ArgumentParser(description="Training CNN")
